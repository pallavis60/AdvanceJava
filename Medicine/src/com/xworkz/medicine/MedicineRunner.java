...
public class MedicineRunner {
	...
	public static void main(String[] args) {
		...
		MedicineDto dto = new MedicineDto(1, "Alprazolam", "anxietyAndPanicDisorder", 500, "benzodiazepine",
				"tiredness");
		MedicineDto dto1 = new MedicineDto(2, "Amlodipine", "highBloodPressure", 1000, "dicarboxylate", "headache");
		MedicineDto dto2 = new MedicineDto(3, "Aripiprazole", "Tourette Syndrome", 2000, "dihydrocarbostyil",
				"Indigestion");
	...
	//	 boolean save=service.save(dto1);
		...
		System.out.println(list);
		 ...
		 boolean updating = service.updateNameAndIdBysideEffect("Paracetamol", 6000,
		 "'tiredness'");
		 System.out.println(updating);

		// boolean dlt = service.deleteByName("'Aripiprazole'");
		// System.out.println(dlt);
	//	System.out.println("==========================================================================");

		boolean dlt1 = service.deleteByNameAndSideEffect("'Amlodipine'",
		 "'headache'");
